...
<template>
  <div
    :class="[
      ...
      isImpostor ? 'bg-error/70 border-2 border-error' : 'bg-success/70 border-2 border-success'
    ]"
  >
    <div class="text-center p-8">
      ...
      <div class="mb-8">
        ...
        >
          {{ isImpostor ? 'Descubrí la palabra secreta!' : 'Descubrí al impostor!' }}
        </div>
      </div>

      <!-- Secret Word (only for regular players) -->
      <div v-if="!isImpostor && secretWord" class="mb-8">
        <div class="text-xl text-highlighted mb-2">Tu palabra secreta es:</div>
      ...
      <div v-if="isImpostor" class="mb-8">
      ...
      <div class="mt-8">
        ...
        <div
          :class="[
            ...
            isImpostor ? 'bg-error' : 'bg-success'
          ]"
        >
          <div
            :class="[
              'h-full transition-all duration-1000',
              isImpostor ? 'bg-error/50' : 'bg-success/50'
            ]"
